...
function RegisterForm() {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-6">
      ...
      <button
        type="submit"
        className="cursor-pointer rounded-main p-2 border-2 border-border-secondary text-md bg-bg-secondary hover:bg-bg-tertiary hover:scale-105 transition-all duration-200 "
        form="register"
      >
        Register in Unicord
      </button>
